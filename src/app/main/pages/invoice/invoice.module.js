    ...
    function config($stateProvider, $translatePartialLoaderProvider, msApiProvider, msNavigationServiceProvider)
    {
        ...
        $stateProvider
            .state('app.pages_invoice_modern', {
                ...
                views    : {
                    'content@app': {
                        templateUrl: 'src/app/main/pages/invoice/views/modern/modern.html',
            ...
            .state('app.pages_invoice_compact', {
                ...
                views    : {
                    'content@app': {
                        templateUrl: 'src/app/main/pages/invoice/views/compact/compact.html',
                        controller : 'InvoiceController as vm'
                    }
                },
                resolve  : {
        ...
        // Translation
        $translatePartialLoaderProvider.addPart('src/app/main/pages/invoice');

        // Api
        msApiProvider.register('invoice', ['src/app/data/invoice/invoice.json']);
