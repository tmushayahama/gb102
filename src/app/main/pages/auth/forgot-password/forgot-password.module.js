(function ()
{
    ...
    function config($stateProvider, $translatePartialLoaderProvider, msNavigationServiceProvider)
    {
        ...
        $stateProvider.state('app.pages_auth_forgot-password', {
            ...
            views    : {
                'main@'                                 : {
                    templateUrl: 'src/app/core/layouts/content-only.html',
                    controller : 'MainController as vm'
                },
                'content@app.pages_auth_forgot-password': {
                    templateUrl: 'src/app/main/pages/auth/forgot-password/forgot-password.html',
        ...
        // Translation
        $translatePartialLoaderProvider.addPart('src/app/main/pages/auth/forgot-password');
