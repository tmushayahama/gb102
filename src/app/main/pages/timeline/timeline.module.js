    ...
    function config($stateProvider, msApiProvider, msNavigationServiceProvider)
    {
        ...
        $stateProvider
            .state('app.pages_timeline', {
                ...
                views    : {
                    'content@app': {
                        templateUrl: 'src/app/main/pages/timeline/timeline.html',
            ...
            .state('app.pages_timeline_left', {
                ...
                views    : {
                    'content@app': {
                        templateUrl: 'src/app/main/pages/timeline/timeline-left.html',
                        controller : 'TimelineController as vm'
                    }
                },
                resolve  : {
            ...
            .state('app.pages_timeline_right', {
                ...
                views    : {
                    'content@app': {
                        templateUrl: 'src/app/main/pages/timeline/timeline-right.html',
                        controller : 'TimelineController as vm'
                    }
                },
                resolve  : {
        ...
        // API
        msApiProvider.register('timeline.page1', ['src/app/data/timeline/page-1.json']);
        msApiProvider.register('timeline.page2', ['src/app/data/timeline/page-2.json']);
        msApiProvider.register('timeline.page3', ['src/app/data/timeline/page-3.json']);
