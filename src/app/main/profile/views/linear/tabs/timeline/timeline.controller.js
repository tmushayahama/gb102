(function ()
{
 ...
 angular
         .module('app.profile')
         .controller('ProfileLinearTimelineController', ProfileLinearTimelineController);

 /** @ngInject */
 function ProfileLinearTimelineController(ExplorerComponentService, msApi, $q, $stateParams, $rootScope)
 {
  var vm = this;
