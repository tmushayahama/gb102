(function ()
{
    ...
    function MailController($scope, $rootScope, $document, $mdDialog, $mdMedia, $mdSidenav, $state, msApi, Folders, Labels)
    {
        ...
        vm.views = {
            classic: 'src/app/main/apps/mail/views/classic/classic-view.html',
            outlook: 'src/app/main/apps/mail/views/outlook/outlook-view.html'
        };
        ...
        function composeDialog(ev)
        {
            $mdDialog.show({
                ...
                templateUrl        : 'src/app/main/apps/mail/dialogs/compose/compose-dialog.html',
