(function ()
{
 ...
 angular
         .module('app.explorer')
         .controller('ComponentRowController', ComponentRowController);

 /** @ngInject */
 function ComponentRowController($stateParams, $document, $window, $timeout, $mdDialog, msUtils, ExplorerComponentService, CardFilters, DialogService)
 {
  var vm = this;
