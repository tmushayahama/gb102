(function ()
{
 ...
 /** @ngInject */
 function cardQuestionController($scope, $timeout, ExplorerComponentService, msUtils)
 {
  var vm = this;
 ...
 function cardQuestiondDirective($document, $window, $timeout)
 {
  return {
   ...
   templateUrl: 'src/app/main/apps//directives/ms-sb-add-card/ms-sb-add-card.html',
   scope: {
    msListId: '='
   },
