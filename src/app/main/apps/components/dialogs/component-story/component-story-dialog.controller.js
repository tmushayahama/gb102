(function ()
{
 ...
 /** @ngInject */
 function ComponentStoryDialogController(add_component_tabs, level_categories, $state, $document, $mdDialog, fuseTheming, fuseGenerator, msUtils, ComponentService, MentorshipService, componentId, startTabIndex, preselectedData) {
