(function ()
{
 ...
 angular
         ...
         .controller('ComponentNotesDialogController', ComponentNotesDialogController);

 /** @ngInject */
 function ComponentNotesDialogController(add_component_tabs, level_categories, $scope, $document, $mdDialog, fuseTheming, fuseGenerator, msUtils, DialogService, ComponentService, componentId, section) {
