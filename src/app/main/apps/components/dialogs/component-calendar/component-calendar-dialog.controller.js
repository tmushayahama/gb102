(function ()
{
 ...
 angular
         ...
         .controller('ComponentCalendarDialogController', ComponentCalendarDialogController);

 /** @ngInject */
 function ComponentCalendarDialogController(ComponentService, $rootScope, $stateParams, $document, $timeout, $scope, $mdSidenav, $mdDialog) {
