(function ()
{
    ...
    angular
        .module('app.matcher')
        .controller('MatcherCalendarEventDialogController', MatcherCalendarEventDialogController);

    /** @ngInject */
    function MatcherCalendarEventDialogController($mdDialog, dueDate, BoardService, msUtils)
    {
        var vm = this;
