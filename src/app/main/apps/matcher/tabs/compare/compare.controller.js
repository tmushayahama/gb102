(function ()
{
 ...
 angular
         .module('app.matcher')
         .controller('MatcherCompareTabController', MatcherCompareTabController);

 /** @ngInject */
 function MatcherCompareTabController(level_categories, MatcherService, $scope, $rootScope)
 {
  var vm = this;
