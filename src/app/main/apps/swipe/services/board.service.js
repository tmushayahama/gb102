(function ()
{
 ...
 function BoardService($q, msApi)
 {
  ...
  function getBoards()
  {
   ...
   msApi.request('swipe.components@get',
           function (response)
           {
  ...
  function getBoardsByType(appName)
  {
   ...
   msApi.request('swipe.componentsByType@query', {appName: appName},
           function (response)
           {
            //service.data = response;
            deferred.resolve(response);
  ...
  function getBoard(boardId, listFormat)
  {
   ...
   msApi.request('swipe.component@get', {id: boardId, listFormat: listFormat},
           function (response)
           {
            //service.data = response;
            deferred.resolve(response);
  ...
  function getCard(cardId, listFormat)
  {
   ...
   msApi.request('swipe.component@get', {id: cardId, listFormat: listFormat},
           function (response)
           {
            // Resolve the promise
            deferred.resolve(response);
  ...
  function createComponent(componentData)
  {
   ...
   msApi.request('swipe.createComponent@save', {}, componentData,
           function (response)
           {
            // Resolve the promise
            deferred.resolve(response);
  ...
  function addNewBoard()
  {
   ...
   _generateEmptySwipeObject().then(
           // SUCCESS
                   function (response)
                   {
                    // Attach the data
           ...
           * swipe object for demonstration
           * purposes
           *
           * @private
           * returns {$promise}
           */
          function _generateEmptySwipeObject()
          {
           // Create a new deferred object
           var deferred = $q.defer();
