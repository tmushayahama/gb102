(function ()
{
    ...
    angular
        .module('app.swipe')
        .controller('SwipeCalendarEventDialogController', SwipeCalendarEventDialogController);

    /** @ngInject */
    function SwipeCalendarEventDialogController($mdDialog, dueDate, BoardService, msUtils)
    {
        var vm = this;
