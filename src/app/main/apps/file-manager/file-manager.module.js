(function ()
{
    ...
    function config($stateProvider, $translatePartialLoaderProvider, msApiProvider, msNavigationServiceProvider)
    {
        ...
        $stateProvider.state('app.file-manager', {
            ...
            views    : {
                'content@app': {
                    templateUrl: 'src/app/main/apps/file-manager/file-manager.html',
        ...
        // Translation
        $translatePartialLoaderProvider.addPart('src/app/main/apps/file-manager');

        // Api
        msApiProvider.register('fileManager.documents', ['src/app/data/file-manager/documents.json']);
