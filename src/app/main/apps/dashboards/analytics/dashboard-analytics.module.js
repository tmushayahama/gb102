(function ()
{
    ...
    function config($stateProvider, msApiProvider)
    {
        ...
        $stateProvider.state('app.dashboards_analytics', {
            ...
            views    : {
                'content@app': {
                    templateUrl: 'src/app/main/apps/dashboards/analytics/dashboard-analytics.html',
        ...
        // Api
        msApiProvider.register('dashboard.analytics', ['src/app/data/dashboard/analytics/data.json']);
    }
