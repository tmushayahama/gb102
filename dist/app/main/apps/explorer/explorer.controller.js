(function ()
{
    ...
    /** @ngInject */
    function ExplorerController($document, $timeout, $scope, $mdSidenav, ExplorerService, LabelsService, $mdDialog)
    {
        var vm = this;

        // Data
        vm.explorer = ExplorerService.data;
         ...
         * @param noteId
         */
        function editComponent(ev, noteId)
        {
            $mdDialog.show({
        ...
        function openSearchToolbar()
        {
            ...
            $timeout(function ()
            {
                angular.element($document.find('#search-explorer-input')).trigger('focus');
