(function ()
{
 ...
 function BoardService($q, msApi)
 {
   ...
   * @returns {*}
   */
  function getBoardData(boardId, listFormat)
  {
   // Create a new deferred object
   var deferred = $q.defer();

   msApi.request('scrumboard.board@get', {id: boardId, listFormat: listFormat},
           function (response)
           {
            // Attach the data
   ...
   * @returns {*}
   */
  function getCardData(cardId, listFormat)
  {
   // Create a new deferred object
   var deferred = $q.defer();

   msApi.request('scrumboard.card@get', {id: cardId, listFormat: listFormat},
           function (response)
           {
            // Resolve the promise
            deferred.resolve(response);
