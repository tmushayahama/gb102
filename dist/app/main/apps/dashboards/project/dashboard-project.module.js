(function ()
{
    ...
    function config($stateProvider, msApiProvider)
    {
        ...
        $stateProvider.state('app.dashboards_project', {
            ...
            views    : {
                'content@app': {
                    templateUrl: 'src/app/main/apps/dashboards/project/dashboard-project.html',
        ...
        // Api
        msApiProvider.register('dashboard.project', ['src/app/data/dashboard/project/data.json']);
    }
