    ...
    function config($stateProvider, msNavigationServiceProvider)
    {
        ...
        $stateProvider
            ...
            .state('app.components_custom-directives.ms-card', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-card.html',
            ...
            .state('app.components_custom-directives.ms-form-wizard', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-form-wizard.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-info-bar', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-info-bar.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-masonry', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-masonry.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-material-color-picker', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-material-color-picker.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-nav', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-nav.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-navigation', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-navigation.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-random-class', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-random-class.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-responsive-table', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-responsive-table.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-scroll', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-scroll.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-search-bar', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-search-bar.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-shortcuts', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-shortcuts.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-sidenav-helper', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-sidenav-helper.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-splash-screen', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-splash-screen.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-stepper', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-stepper.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-timeline', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-timeline.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            })
            .state('app.components_custom-directives.ms-widget', {
                ...
                views: {
                    'content@app': {
                        templateUrl: 'src/app/main/components/custom-directives/pages/ms-widget.html',
                        controller : 'CustomDirectivesController as vm'
                    }
                }
            });
