...
var teachsCtrl = function (
 ...
 vm.openAddTeachModal = function () {
  var modalInstance = $uibModal.open({
   animation: true,
   templateUrl: 'add-teach-modal.html',
   controller: 'AddTeachCtrl as addTeachCtrl',
   backdrop: 'static',
   size: 'xl',
   resolve: {
    teachLevels: function () {
     return vm.teachLevels;
    }
   }
  });
 ...
 //--------init------
 //vm.teachsManager.getTeachs(vm.teachId);
...
angular.module("app.teachs").controller('TeachsCtrl', teachsCtrl);