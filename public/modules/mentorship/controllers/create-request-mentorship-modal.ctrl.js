var createRequestMentorshipCtrl = function (
        ConstantsSrv,
        level_categories,
        $uibModalInstance,
        WizardHandler,
 ...
 vm.chooseRequestOption = function (requestOption) {
  vm.mentorship.requestOptionId = requestOption.id;
  vm.mentorship.app_type_id = requestOption.level.app_type_id;
  vm.mentorship.parent_mentorship_id = requestOption.mentorship_id;
  vm.mentorship.title = requestOption.mentorship.title;
  vm.mentorship.description = requestOption.mentorship.description;
...
createRequestMentorshipCtrl.$inject = [
 'ConstantsSrv',
 'level_categories',
 '$uibModalInstance',
 'WizardHandler',
...
angular.module("app.mentorship").controller('CreateRequestMentorshipCtrl', createRequestMentorshipCtrl);
