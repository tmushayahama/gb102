var mentorshipTodosSrv = function ($http, $q) {
 ...
 MentorshipTodosSrv.prototype.getMentorshipTodos = function (mentorshipId, levelId) {
  var self = this;
  var deferred = $q.defer();
  //self.mentorshipTodos = [];
  $http.get('/api/mentorship/' + mentorshipId + '/todos/' + levelId).success(function (data) {
 ...
 MentorshipTodosSrv.prototype.todoChecklistStatusData = function (todoId) {
  var self = this;
  var deferred = $q.defer();
