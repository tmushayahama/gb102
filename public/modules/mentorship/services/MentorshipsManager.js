var mentorshipsManager = function ($http, $q) {
 ...
 MentorshipsManager.prototype.getAppMentorships = function (appName) {
  var self = this;
  var deferred = $q.defer();
  // self.mentorships = [];
...
mentorshipsManager.$inject = ['$http', '$q'];

angular.module('app.mentorship').service('MentorshipsManager', mentorshipsManager);
