var promiseWeblinkManager = function ($http, $q) {
...
promiseWeblinkManager.$inject = ['$http', '$q'];

angular.module('app.promises').service('PromiseWeblinkManager', promiseWeblinkManager);