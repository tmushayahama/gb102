var mentorshipTodoManager = function ($http, $q) {
...
mentorshipTodoManager.$inject = ['$http', '$q'];

angular.module('app.mentorships').service('MentorshipTodoManager', mentorshipTodoManager);
