var mentorshipWeblinksManager = function ($http, $q) {
...
mentorshipWeblinksManager.$inject = ['$http', '$q'];

angular.module('app.mentorships').service('MentorshipWeblinksManager', mentorshipWeblinksManager);