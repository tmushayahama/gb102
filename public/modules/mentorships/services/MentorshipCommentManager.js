var mentorshipCommentManager = function ($http, $q) {
...
mentorshipCommentManager.$inject = ['$http', '$q'];

angular.module('app.mentorships').service('MentorshipCommentManager', mentorshipCommentManager);
