var mentorshipTodosManager = function ($http, $q) {
...
mentorshipTodosManager.$inject = ['$http', '$q'];

angular.module('app.mentorships').service('MentorshipTodosManager', mentorshipTodosManager);