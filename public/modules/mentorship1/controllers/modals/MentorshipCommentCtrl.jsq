var mentorshipCommentCtrl = function (
 ...
 vm.mentorshipCommentSrv = new MentorshipCommentSrv();
 ...
 vm.getMentorshipComment = function (mentorshipId, commentId) {
  vm.mentorshipCommentSrv.getMentorshipComment(mentorshipId, commentId).then(function (response) {
  }, function (error) {
   console.log(error);
  });
 };
 ...
 vm.editMentorshipComment = function (data) {
  vm.mentorshipCommentSrv.editMentorshipComment(data).then(function (response) {
  }, function (response) {
...
angular.module("app.mentorship").controller('MentorshipCommentCtrl', mentorshipCommentCtrl);
