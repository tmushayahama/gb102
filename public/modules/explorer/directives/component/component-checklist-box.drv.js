angular.module('app.explorer').directive('gbComponentChecklistBox',
        ['ComponentsSrv',
         'level_categories',
         '$q',
         function (
          ...
          return {
           ...
           //replace: true,
           templateUrl: "public/modules/explorer/views/templates/component/component-checklist-box.tpl.html",
           scope: {
            //templateUrl: '@',
            component: '=',
            getComponent: '&',
