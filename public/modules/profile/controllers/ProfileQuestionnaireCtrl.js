var profileQuestionnaireCtrl = function (
        level_categories,
        ConstantsSrv,
        QuestionnaireSrv,
        $scope,
...
profileQuestionnaireCtrl.$inject = [
 'level_categories',
 'ConstantsSrv',
 'QuestionnaireSrv',
 '$scope',
...
angular.module("app.profile").controller('profileQuestionnaireCtrl', profileQuestionnaireCtrl);
